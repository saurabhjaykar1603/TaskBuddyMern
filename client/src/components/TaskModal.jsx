      ...
      <div className="bg-white rounded-xl border border-purple-100 max-w-md w-full shadow-lg p-6 relative animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            disabled={loading}
            type="submit"
            className="w-full bg-gradient-to-r from-fuchsia-500 to-purple-600 text-white font-medium py-2.5 px-4 rounded-lg flex items-center justify-center gap-2 disabled:opacity-50 hover:shadow-md transition-colors duration-300 cursor-pointer"
          >
            {loading ? (
              "Saving..."
            ) : taskData.id ? (
